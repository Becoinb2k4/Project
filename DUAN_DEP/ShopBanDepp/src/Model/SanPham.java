...
public class SanPham {
    ...
    public SanPham(String maSP, String tenSP, String donGia, String soLuong) {
        this.maSP = maSP;
        this.tenSP = tenSP;
        this.donGia = donGia;
        this.soLuong = soLuong;
    ...
    public String getTrangThai() {
        return Integer.parseInt(soLuong) > 0 ? "1" : "0";
    }
    ...
    public Object[] todataRowBanHang() {
        return new Object[]{
            this.maSP, this.tenSP, this.getDonGia2(), this.mauSac, this.chatLieu, this.kichThuoc, this.soLuong
        };
    }

    public int getTongGiaTien() {
    
    return Integer.parseInt(this.donGia) * Integer.parseInt(this.soLuong);
}

    public Object[] toDataRowGioHang() {
        return new Object[]{
            this.maSP, this.tenSP,this.donGia, this.soLuong, this.getTongGiaTien()
        };
    }

    public Object[] todataRowSPCT() {
        return new Object[]{
            this.maSPCT, this.maSP, this.tenSP, this.chatLieu, this.kichThuoc, this.mauSac, this.soLuong, this.nhaSX, this.xuatXu, this.getDonGia(), this.moTa
        };
    }
    public int soluongInt(){
